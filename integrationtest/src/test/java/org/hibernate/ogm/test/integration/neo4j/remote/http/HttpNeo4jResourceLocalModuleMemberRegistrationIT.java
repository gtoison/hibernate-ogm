...
import org.hibernate.ogm.test.integration.neo4j.remote.controller.RemoteNeo4jResourceLocalCleaner;
...
public class HttpNeo4jResourceLocalModuleMemberRegistrationIT extends Neo4jModuleMemberRegistrationScenario {
	...
	public static Archive<?> createTestArchive() throws Exception {
		return new ModuleMemberRegistrationDeployment
				...
				.manifestDependencies( "org.hibernate.ogm:${module-slot.org.hibernate.ogm.short-id} services, org.hibernate.ogm.neo4j:${module-slot.org.hibernate.ogm.short-id} services" )
				.createDeployment();
	}
